	...
	return (
		<div
			className="flex flex-col 
               ...
               w-full
                p-4  gap-4  ">
					<button onClick={()=>{router.push("/games/game?gametype=online&oppid=2")}}>test1</button>
					<button onClick={()=>{router.push("/games/game?gametype=online&oppid=1")}}>test2</button>
			...
			<div
				className=" flex-1 min-h-80 py-2 px-4  md:w-[calc(100vw-125px)] max-md:w-[clac(100vw-40px)] gap-4    overflow-x-scroll  
            flex 
           ...
           [&::-webkit-scrollbar]:h-2">
			...
			<div className="flex gap-4 flex-col flex-1">
				<div className="flex justify-center flex-none w-3/5 self-center relative">
					...
					<div
						className={`absolute h-2 w-full bottom-0 rounded-full bg-amber-50`}>
						<div
							className={`absolute transition-all duration-300 h-2 w-1/3 ${
								skinType == "table"
									? "left-0"
									: skinType == "ball"
									? "left-1/3"
